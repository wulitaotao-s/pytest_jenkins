...
def main():
    ...
    # 拆分为列表
    passed_list = [t.strip() for t in passed_str.split(',') if t.strip()]
    failed_list = [t.strip() for t in failed_str.split(',') if t.strip()]
